...
//         return "Ah yes, the color blue is legit, like the sky!";
//     } else if (colorName.toLowerCase() === "green") {
//         return "The green green grass...";
//     } else if (colorName.toLowerCase() === "red") {
//         return "The red blood moon rises once again..."
//     } else {
//         return `Wow, I have nothing to say about ${colorName}!`;
//     }
// }
...
let faveColor = prompt("Buddy the elf here, what's your favorite color?");
...
function calculateTotal(luckyNum, totalPrice) {
    ...
    if (luckyNum === 0) {
        ...
        discount = totalPrice * .35;
    } else if (luckyNum === 4) {
        discount = totalPrice * .50;
    } else if (luckyNum === 5) {
        discount = totalPrice;
    }
...
function isNegOrPos(someNumber) {
    let answer;
...
if (wantToEnterANumber === true) {
    ...
    if (parseFloat(theirEnteredNumber)) {
        alert(`Your number plus 100 = ${parseFloat(theirEnteredNumber) + 100}`);
